...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'list.wast';
  var wasmBinaryFile = 'list.wasm';
  var asmjsCodeFile = 'list.temp.asm.js';
...
var ASM_CONSTS = [function($0) { console.log('\tcreatenode: ' + $0); },
 function($0) { console.log('\ttemp->data: ' + $0); }];
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_list_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
Module['wasmTableSize'] = 449;

Module['wasmMaxTableSize'] = 449;
...
var real___GLOBAL__sub_I_list_cpp = asm["__GLOBAL__sub_I_list_cpp"]; asm["__GLOBAL__sub_I_list_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_list_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_list_cpp = Module["__GLOBAL__sub_I_list_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_list_cpp"].apply(null, arguments) };
